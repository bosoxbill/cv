...
\begin{aside}
  \section{contact}
    ...
    \href{https://www.linkedin.com/in/billdesmarais}{myself@linkedin}
    \href{https://github.com/bosoxbill}{I@github}
    ~
    +1.978.809.2597
  \section{languages}
    Ruby, JavaScript, 
...
\begin{entrylist}
  \entryalt
    ...
    \begin{itemize}
      ...
      \item Hands-on in code, architecture, and all phases of product development
      \item Delivered Wellist 1.0, providing customizable platform to serve oncology, cardiology, gerontology, ob/gyn, transplant and more

...
\begin{entrylist}
  \entryalt
    ...
    \begin{itemize}
      \item Worked with product, occasionally owning product, as we iterated to find market fit
      ...
      \item Architecture: Amazon AWS, k8s, ruby on rails (api), 2 es6 functional react/redux frontends, landing pages and ipad-based kiosks
      \item Additionally responsible for hiring, recruiting, HIPAA compliance, and company IT
      \item Company won Mass TLC Innovative Tech of the year, and 50 on Fire - Health Tech, as well as Company of the Year (Silver Stevie) and a Diversity Leadership award (Rock Health)
    \end{itemize}}
